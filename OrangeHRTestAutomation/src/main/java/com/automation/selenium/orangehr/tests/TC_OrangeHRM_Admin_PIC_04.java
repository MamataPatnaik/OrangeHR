...
public class TC_OrangeHRM_Admin_PIC_04 extends TestSetUpBase{
	...
	//private By uploadsuccessMsg=By.cssSelector("div:nth-child(1) div:nth-child(3) div.box.pimPane:nth-child(1) div.inner:nth-child(3) > script:nth-child(1)");
	 ...
	 @Test
	 public void uploadPicInvalidFormat() {
	 ...
	 Assert.assertTrue(photoPageObj.uploadPicFail("C:\\Users\\neebal\\trial.txt","Failed to Save: File Type Not Allowed"), "Photo  uploaded successfully or fail message not displayed");
	 }
